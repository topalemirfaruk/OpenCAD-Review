    ...
    return (
        <main className="relative max-w-7xl mx-auto px-4 pt-32 pb-24">
            ...
            <div className="absolute inset-0 z-50 flex items-center justify-center p-4">
                <div className="sticky top-[40%] glass-panel p-10 rounded-3xl border-accent/30 text-center space-y-4 shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-md max-w-md mx-auto">
                    <div className="w-16 h-16 rounded-2xl bg-accent/20 border border-accent/30 flex items-center justify-center text-accent mx-auto mb-6">
                        <Activity className="w-8 h-8 animate-pulse" />
                    </div>
                    <h2 className="text-2xl font-bold text-glow">Geliştirme Aşamasında</h2>
                    <p className="text-foreground/70 text-sm leading-relaxed">
                        Kişisel çalışma alanı ve proje yönetimi özellikleri şu an aktif geliştirme aşamasındadır.
                        Modellerinizi yerel olarak incelemeye devam edebilirsiniz!
                    </p>
                    <div className="pt-4 flex gap-3">
                        <Link href="/viewer" className="flex-1 h-11 bg-primary text-primary-foreground rounded-xl flex items-center justify-center font-bold text-sm hover:bg-primary/90 transition-all">
                            Görüntüleyiciye Dön
                        </Link>
                    </div>
                </div>
